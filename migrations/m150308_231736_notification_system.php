...
class m150308_231736_notification_system extends Migration
{
    ...
    public function safeUp()
    {
		...
		$this->addColumn('{{%follow_user_api}}', 'last_seen', Schema::TYPE_TIMESTAMP . ' NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
		...
		$this->addColumn('{{%follow_user_user}}', 'last_seen', Schema::TYPE_TIMESTAMP . ' NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
